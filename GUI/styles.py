INDICATOR = ["background:gray;color:white;border-color:black;border-radius: 10px;", 
             "background:#46c864;color:black;border-color:black;border-radius: 10px;"]

INDICATOR_TEXT = ["Extraído", "Insertado"]
